...
const geocode = (address, callback) => {
    const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + encodeURIComponent(address) + '.json?access_token=pk.eyJ1IjoibWFpNzExIiwiYSI6ImNrcDgwMHpvNDA0bmoydnJwdTV4YXBscGEifQ.ghB7957J6-qW7QBAknzuWQ&limit=1'

    request({ url, json: true }, (error, response1) => {
        if (error) {
